-- Update static pages with HTML-formatted content
-- Purpose: Fix display rendering by converting Markdown to HTML
-- Date: 2025-10-10

BEGIN;

-- Update Privacy Policy with HTML-formatted content
UPDATE static_pages 
SET content = $PRIVACY$
...
-- Update Terms of Service with HTML-formatted content
UPDATE static_pages 
SET content = $TERMS$
